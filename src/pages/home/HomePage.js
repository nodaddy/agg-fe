  ...
  return <div style={{minHeight: '100vh', background: "#663399 no-repeat fixed left", backgroundSize: "cover", padding: '35px'}}>
    ...
    <Row style={{marginTop: '10vh'}}>
        ...
        <Col xs={{span: 0}} md={{span: 18}}>
            <p style={{fontSize: '30px', fontFamily: 'roboto', color: 'silver'}}>From <span style={{color: 'white'}}>websites</span> and <span style={{color: 'white'}}>portfolios</span> <br/> to mobile <span style={{color: 'white'}}>apps</span>, <br/>we’ll create your <i style={{color: 'white'}}>amazing online presence.</i></p>
        </Col>
        <Col xs={{span: 18}} md={{span: 0}}>
            <p style={{fontSize: '25px', fontFamily: 'roboto', color: 'silver'}}>From <span style={{color: 'white'}}>websites</span> and <span style={{color: 'white'}}>portfolios</span> <br/> to mobile <span style={{color: 'white'}}>apps</span>, <br/>we’ll create your <i style={{color: 'white'}}>amazing online presence.</i></p>
        </Col>
        <Col xs={{span: 3}}></Col>
    </Row>
    ...
    <div align="left" style={{color: 'YELLOW'}}>Our Clients</div>
            ...
            <div style={{display: 'flex', flexWrap: 'nowrap', overflowX: 'scroll', color: 'white', fontSize: '18px', fontFamily: 'roboto'}}>
                <span style={{minWidth: '100px', maxWidth: '100px', border: '0px solid black', marginRight: '37px', textAlign: 'left', marginTop: '20px'}}>
                    RKMINlogo
                </span>
                <span style={{minWidth: '100px', maxWidth: '100px', border: '0px solid black', marginRight: '37px', textAlign: 'left', marginTop: '20px'}}>
                    ADlogo
            ...
            <br/>
            <div align="left" style={{color: 'YELLOW'}}>Testimonials</div>
            <hr style={{backgroundColor: 'yellow'}}/>
            <div style={{display: 'flex', flexWrap: 'nowrap', overflowX: 'scroll', color: 'white', fontSize: '18px', fontFamily: 'roboto'}}>
